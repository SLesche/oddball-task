...
if ~exist('expinfo.Colors.bgColor','var')
    expinfo.Colors.bgColor = [140 140 140]; % Default Background Color is white
end
...
[expinfo.xCenter, expinfo.yCenter] = RectCenter(expinfo.rect);
[expinfo.XPixels, expinfo.YPixels] = Screen('WindowSize', expinfo.window);
